...
CREATE TABLE `inference_request_table` (
  `inference_req_id` int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
  ...
  `business_metrics` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `creation_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `status` enum('In_progress','Success','Failure') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
