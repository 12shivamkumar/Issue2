CREATE TABLE `dvf_request_table` (
 `creation_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
 `dvf_req_id` int(11) NOT NULL AUTO_INCREMENT,
 `org_id` int(11) NOT NULL,
 `status` enum('In_progress','Success','Failure') COLLATE utf8mb4_unicode_ci NOT NULL,
