...
CREATE TABLE `message_queue` (
  ...
  `scheduled_type` enum('IMMEDIATELY','SCHEDULED','PARTICULAR_DATE', 'TIME_RANGE') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
