CREATE TABLE `target_rules` (
  ...
  `target_type` enum('QUANTITY','SALES','COUNT','VISIT','GROSS_SALES') COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `enrolment_method` ENUM('TRANSACTION','IMPORT') DEFAULT 'IMPORT' NOT NULL,
