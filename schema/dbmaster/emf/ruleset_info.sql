...
CREATE TABLE `ruleset_info` (
  ...
  `owner` enum('DVS_ENDPOINT','POINTSENGINE_ENDPOINT','SOCIAL_ENDPOINT','REFERRAL_ENDPOINT','TIMELINE_ENDPOINT','TARGETLOYALTY_ENDPOINT','PROMOTION_EARNING_ENDPOINT') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
