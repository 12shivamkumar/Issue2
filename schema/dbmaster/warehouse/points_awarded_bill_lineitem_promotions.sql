...
CREATE TABLE `points_awarded_bill_lineitem_promotions` (
  ...
  UNIQUE KEY `program_id_idx` (`org_id`,`program_id`,`customer_id`,`point_category_id`,`bill_lineitem_id`,`promotion_id`,`event_log_id`),
