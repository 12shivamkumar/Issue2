...
CREATE TABLE `points_deductions` (
  ...
  `deduction_type` enum('REDEEMED','EXPIRED','CANCELLED','MIGRATION','RETURN','REDEEMED_BY_TRANSFER','REDEMPTION_REVERSAL','EXPIRY_REVERTED','REDEMPTION_REVERTED','REDEEMED_BY_TRANSFER_REVERTED','REDEEMED_BY_CONVERSION','RETURN_HISTORICAL') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
