...
CREATE TABLE `customer_slab_upgrade_history` (
  ...
  `enrollment_id` bigint(20) NOT NULL DEFAULT -1,
  PRIMARY KEY (`id`,`org_id`),
  UNIQUE KEY `program_id` (`org_id`,`program_id`,`customer_id`,`upgraded_on`,`from_slab_id`,`to_slab_id`),
  KEY `auto_time_idx` (`upgraded_on`) ,
