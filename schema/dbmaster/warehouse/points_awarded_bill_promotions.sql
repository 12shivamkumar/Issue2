...
CREATE TABLE `points_awarded_bill_promotions` (
  ...
  `bill_id` bigint(20) NOT NULL COMMENT 'ID of the Lineitem against which point is awarded',
  ...
  UNIQUE KEY `program_id_idx` (`org_id`,`program_id`,`customer_id`,`point_category_id`,`bill_id`,`promotion_id`,`event_log_id`,`awarded_date`),
